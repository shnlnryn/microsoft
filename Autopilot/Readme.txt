...
2. You now need to switch to the USB drive. To identify which drive letter is assigned, in the command prompt, type DISKPART, then "list volume" You will see a list of drives including the USB drive. type 'exit' a to exit out of Diskpart. Change to the USB drive directory where the Autopilot files are.
